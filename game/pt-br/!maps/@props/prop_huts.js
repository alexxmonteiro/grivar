...
export async function fhut_triggerProp() {
        console.clear();
        console.log(chalk.yellow.italic(`A luz das tochas, mesmo fraca, ilumina a entrada da cabana, um sentimento de segurança paira levemente sobre o ar, uma falsa nostalgia te atravessa o peito, não existe perigo, porém, está errado, não da pra dizer o que, mas o silencio da noite gera uma inquietude, onde está o chirriar das corujas? Que se fazem presentes em períodos noturnos, ou a chata e incessante estridulação dos grilos? Nada há no que deveria haver, apenas o som de sua respiração e o estralar repetitivo e artificial das tochas se fazem presentes. Atacado por esse sentimento estranho você decide entrar na cabana...`));
        prompt();

        console.log(chalk.yellow.italic(`Enquanto inspeciona o local, em cima de uma mesa, iluminado por uma vela de cera de abelha, essa que exala um odor adocicado e agradável, do lado de uma pena e tinta ferrogálica, é possível ver um pergaminho com uma mensagem escrita nele.
