...
export function actOne() {
        ...
        prompt();
        console.log(chalk.yellow.italic(`Ao adentrar o local, é perceptível o desgaste do tempo, as ripas de madeira estalam com o vento, o cheiro de madeira molhada percorre suas narinas, o fato dessa estrutura ainda estar de pé é um misterio, em um canto menos castigado você se escora, improvisa bandagens feitas de trapos velhos do revestimento de pano do compartimento de carga que você pegou dos restos do que um dia foi uma carroça, você acabou pegando no sono.`));
        prompt();
...
export async function bossFight() {
        ...
        prompt(chalk.yellow.italic(`Você se encontra em pânico, nada poderia ter te preparado para aquilo que agora te encara — profundamente, sem nunca desviar o olhar.\n`));
