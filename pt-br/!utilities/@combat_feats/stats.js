...
export async function stats(enemy_id) {
    ...
    console.log(chalk.white.italic(`BRAÇO DIREITO: ${chalk.yellow.bold(enemies.enemyLifePoints(enemy_id)[3].toFixed(1))}`));
    console.log(chalk.white.italic(`BRAÇO ESQUERDO: ${chalk.yellow.bold(enemies.enemyLifePoints(enemy_id)[4].toFixed(1))}`));
    console.log(chalk.white.italic(`PERNA DIREITA: ${chalk.yellow.bold(enemies.enemyLifePoints(enemy_id)[5].toFixed(1))}`));
    console.log(chalk.white.italic(`PERNA ESQUERDA: ${chalk.yellow.bold(enemies.enemyLifePoints(enemy_id)[6].toFixed(1))}`));
    console.log(chalk.yellow.italic("\n--P O N T O S   D E   A T A Q U E--"));
    console.log(chalk.white.italic(`BRAÇO DIREITO: ${chalk.yellow.bold(enemies.enemyAttack(enemy_id)[1].toFixed(1))}`));
    console.log(chalk.white.italic(`BRAÇO ESQUERDO: ${chalk.yellow.bold(enemies.enemyAttack(enemy_id)[2].toFixed(1))}`));
    prompt();
}
